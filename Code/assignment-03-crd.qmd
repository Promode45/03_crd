...
```{r data import}
df <- read_csv("../Data/wheat_nk_bamyan.csv")
df
...
Based on the ANOVA table, there is no significant interaction effects and hence we proceed to testing the effects of indivitual treatments which are both significant. 
...
From the anova table, we have seen that interaction effects have been significant, and we will extract means for this. 
```{r}
means <- emmeans(mod, 
